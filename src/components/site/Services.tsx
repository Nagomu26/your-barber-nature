import { Scissors, Sparkles, Brush, Wand2, ArrowRight } from "lucide-react";
import { CONFIG } from "@/lib/config";
import { SERVICIOS } from "@/data/services";
import type { ServiceId } from "@/lib/types";
import { Reveal } from "./Reveal";

const ICONOS: Record<ServiceId, typeof Scissors> = {
  corte: Scissors,
  fade: Sparkles,
  barba: Brush,
  completo: Wand2,
      ...
      <div className="mx-auto max-w-6xl px-5 py-16 sm:px-8 sm:py-24">
        <Reveal className="mb-14 text-center">
          ...
          <p className="mx-auto mt-4 max-w-md text-tintan/70">
            Precios cerrados y sin sorpresas. Tu barbero te aconseja lo que mejor te
            sienta.
          </p>
        </Reveal>
