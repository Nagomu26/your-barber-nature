...
const CARACTERISTICAS = [
  { icono: Leaf, texto: "Ambiente tranquilo", sub: "Un rato para ti" },
  { icono: Clock, texto: "Sin esperas", sub: "Reserva y entra" },
      ...
      <div className="relative mx-auto max-w-6xl px-5 pb-14 pt-14 sm:px-8 sm:pb-20 sm:pt-20">
        <div className="grid items-center gap-14 lg:grid-cols-12">
          <div className="lg:col-span-7">
            <Reveal>
              <p className="font-script mb-4 text-3xl text-terracota">Tu barbería en {CONFIG.ciudad}</p>
            </Reveal>
            ...
            <Reveal delay={160}>
              <p className="mt-6 max-w-xl text-lg leading-relaxed text-tintan/70">
                Barbería de barrio con trato cercano. Elige tu hora online, entra sin prisas y
                relájate mientras te atendemos.
              </p>
            </Reveal>
