          ...
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            <div className="lg:col-span-2">
              ...
              <p className="mt-5 max-w-md text-sm leading-relaxed text-arena/60">
                Tu barbería de confianza, sin prisas. Reserva tu hora online y relájate.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-arena/75">
                {CONFIG.instagram && (
                  <li>
                    <a href={CONFIG.instagram} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 transition-colors hover:text-terracota">
                ...
                {CONFIG.facebook && (
                  <li>
                    <a href={CONFIG.facebook} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 transition-colors hover:text-terracota">
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4 flex-shrink-0" aria-hidden="true">
                ...
                {CONFIG.tiktok && (
                  <li>
                    <a href={CONFIG.tiktok} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 transition-colors hover:text-terracota">
                ...
                {CONFIG.youtube && (
                  <li>
                    <a href={CONFIG.youtube} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 transition-colors hover:text-terracota">
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4 flex-shrink-0" aria-hidden="true">
