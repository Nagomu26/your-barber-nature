...
const IMAGENES = [
  { src: "img/chairs.jpg", alt: "Rincón tranquilo de la barbería", blob: "blob-1" },
  { src: "img/shave.jpg", alt: "Acabado con navaja", blob: "blob-2" },
  { src: "img/haircut-close.jpg", alt: "Detalle de corte a tijera", blob: "blob-1" },
];
